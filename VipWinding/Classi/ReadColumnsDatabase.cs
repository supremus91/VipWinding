...
namespace VipWinding.Classi
{
    ...
    //1) La classe richiede in ingresso cod1 e il nome della tabella da cui attingere
    class ReadColumnsDatabase
    {


        public static void Main(String cod1, String DataBase, String TableName)
        {
            
            SqlConnection con = new SqlConnection(PublicVar.conn_strDB1 + DataBase + PublicVar.conn_strDB2);
            //Ottengo la lista dei nomi delle colonne del database
